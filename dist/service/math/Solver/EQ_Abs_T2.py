...
def step_abs_t2(function, varList, classification):
    datareturn = {}
    step = []
    root = []
    ...
    first_step = []
    first_step.append(eq_json_original(left.args[0], right.args[0]))
    first_step.append(eq_json_original(left.args[0], -right.args[0]))
    step.append(or_json(first_step))

    # stop = 0
    # count = 0
    # if Eq(left.args[0], right.args[0]) == False:
    #     count = 1
    #     stop += 1
    # if Eq(left.args[0], -right.args[0]) == False:
    #     count = 2
    ...
    # if stop == 2:
    #     second_step = []
    #     second_step.append(solve_eq_step(Eq(left.args[0], right.args[0]), varList))
    #     second_step.append(solve_eq_step(Eq(left.args[0], -right.args[0]), varList))
    #     step.append(or_json(second_step))
    # else:
    #     if count == 1:
    #         step.append(solve_eq_step(Eq(left.args[0], right.args[0]), varList))
    #     else:
    #         step.append(solve_eq_step(Eq(left.args[0], -right.args[0]), varList))
...
def abs_t2(function, varList, classification):
    start_time = time.time()
    data = {}
    step_root = step_abs_t2(function, varList, classification)
