...
def step_abs_ineq_t1(function, varList, classification):
    step = []
...
def ineq_t1(function, varList, classification):
    start_time = time.time()
    data = {}
    data["step"] = step_abs_ineq_t1(function, varList, classification)
    data["root"] = solveSimply(function, varList)
    data["time"] = time.time() - start_time
    data["classification"] = "ineq_t1"
    data["category"] = "ineq"
