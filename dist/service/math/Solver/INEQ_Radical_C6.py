...
def step_c6(classification, varList):
    step = []
    ...
    first_step.append(ineq_json(left_expr, " \leq ", right_expr))
...
def solve_radical_ineqSBS_c6(classification, varList):
    datareturn = {}
    ...
    if len(varList) > 0:
        ...
        datareturn["step"] = step_c6(classification, varList)
        datareturn["classification"] = "ineq_c6"
