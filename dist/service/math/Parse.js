...
Parse.checkHaveVariable = function (data) {
    let left;
    let Tree = new Tree_1.default(data);
    return (left = Tree.findOutVariables().length > 0) != null ? left : { true: false };
};
Parse.checkHaveVariableWithName = function (data, varName) {
    let Tree = new Tree_1.default(data);
    return Tree.findOutVariables().map(x => x.value).indexOf(varName) !== -1;
};
Parse.checkIsLinear = function (data) {
...
Parse.checkIsPoly = function (data) {
    switch (data.operation) {
        case 'Number':
            return true;
        case 'Variable':
...
Parse.parseToSymPyDegree = function (data) {
    switch (data.operation) {
        case 'Number':
...
Parse.parseToSymPyRad = function (data) {
    switch (data.operation) {
        case 'Number':
            return data.value.replace(",", ".").replace("empty", "");
        case 'Variable':
...
Parse.parseToSymPyDegreeEq = function (data) {
    switch (data.operation) {
        case 'Number':
            return data.value.replace(",", ".").replace("empty", "");
        case 'Variable':
...
Parse.parseToSymPyRadEq = function (data) {
    switch (data.operation) {
        case 'Number':
            return data.value.replace(",", ".").replace("empty", "");
        case 'Variable':
...
Parse.parseToSymPyForSolutionRad = function (data) {
    switch (data.operation) {
        case 'Number':
            return data.value.replace(",", ".").replace("empty", "");
        case 'Variable':
...
Parse.parseToSymPyForSolutionDegree = function (data) {
    switch (data.operation) {
        case 'Number':
            return data.value.replace(",", ".").replace("empty", "");
        case 'Variable':
...
Parse.getFactor = function (tree, varName) {
...
Parse.parseToLatexExpr = function (data) {
    switch (data.operation) {
        case 'Number':
            return data.value.replace(",", ".").replace("empty", "");
        case 'Variable':
...
Parse.getConditions = function (data) {
    switch (data.operation) {
        case 'Number':
            return "";
        case 'Variable':
