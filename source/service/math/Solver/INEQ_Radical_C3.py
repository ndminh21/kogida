...
def step_c3(function, varList):
    ...
    first_step = []
    first_step.append(ineq_json(right_expr, ">", 0))
    first_step.append(ineq_json(left_expr, ">=", 0))
    first_step.append(ineq_json(left_expr, "<", right_expr**2))
    step.append(and_json(first_step))

    second_step = []
    second_step.append(solveSimply_step(right_expr, ">", 0, varList))
    second_step.append(solveSimply_step(left_expr, ">=", 0, varList))
    second_step.append(solveSimply_step(left_expr, "<", right_expr**2, varList))
...
def solve_radical_ineqSBS_c3(function, varList):
    datareturn = {}
    ...
    if len(varList) > 0:
        ...
        datareturn["step"] = step_c3(function, varList)
        datareturn["classification"] = "ineq_c3"
