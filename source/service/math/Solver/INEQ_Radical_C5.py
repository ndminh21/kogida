...
def step_c5(classification, varList):
    step = []
    ...
    first_step.append(ineq_json(left_expr, " < ", right_expr))
...
def solve_radical_ineqSBS_c5(classification, varList):
    datareturn = {}
    ...
    if len(varList) > 0:
        ...
        datareturn["step"] = step_c5(classification, varList)
        datareturn["classification"] = "ineq_c5"
