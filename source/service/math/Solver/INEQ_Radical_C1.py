...
def step_c1(function, varList):
    ...
    first_step = []
    first_step_a = []
    first_step_a.append(ineq_json(left_expr, ">=", 0))
    first_step_a.append(ineq_json(right_expr, "<", 0))
    first_step_b = []
    first_step_b.append(ineq_json(right_expr, ">=", 0))
    first_step_b.append(ineq_json(left_expr, ">", right_expr**2))
...
def solve_radical_ineqSBS_c1(function, varList):
    datareturn = {}
    ...
    if len(varList) > 0:
        ...
        datareturn["step"] = step_c1(function, varList)
        datareturn["classification"] = "ineq_c1"
