...
def step_c7(classification, varList):
    step = []
...
def solve_radical_ineqSBS_c7(classification, varList):
    datareturn = {}
    ...
    if len(varList) > 0:
        ...
        datareturn["step"] = step_c7(classification, varList)
        datareturn["classification"] = "ineq_c7"
